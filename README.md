...
**Installation:** See [here](https://github.com/khanhas/spicetify-cli/wiki/Installation) ⭐ 24,563 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-18
...
**Installation:** [Releases](https://github.com/rocksdanister/lively/releases) ⭐ 19,641 | 🐛 391 | 🌐 C# | 📅 2026-04-30
...
**Installation:** Download it from the [Microsoft Store](https://www.microsoft.com/en-us/p/notepads-app/9nhl4nsc67wm) or from [GitHub](https://github.com/JasonStein/Notepads) ⭐ 10,257 | 🐛 464 | 🌐 C# | 📅 2026-04-20
...
**Installation:** Download it from [here](https://github.com/Eugeny/tabby/releases) ⭐ 74,583 | 🐛 2,834 | 🌐 TypeScript | 📅 2026-09-16
...
**Installation:** Visit the [GitHub Repo](https://github.com/yshui/picom) ⭐ 4,796 | 🐛 277 | 🌐 C | 📅 2026-06-02 and follow the instructions.
...
**Installation:** Download or compile the app from the [repo](https://github.com/namazso/SecureUxTheme) ⭐ 3,131 | 🐛 21 | 🌐 C++ | 📅 2025-06-30.
...
**Instalation:** Install it via the [Microsoft Store](https://www.microsoft.com/ro-ro/p/translucenttb/9pf4kz2vn4w9?activetab=pivot:overviewtab), or via [GitHub](https://github.com/TranslucentTB/TranslucentTB) ⭐ 20,372 | 🐛 327 | 🌐 C++ | 📅 2026-09-10
...
**Installation**: Install it via the ([Microsoft Store](https://www.microsoft.com/store/productId/9N0DX20HK701), [GitHub](https://github.com/microsoft/terminal#via-github) ⭐ 104,939 | 🐛 1,762 | 🌐 C++ | 📅 2026-09-18, [WinGet](https://github.com/microsoft/terminal#via-windows-package-manager-cli-aka-winget) ⭐ 104,939 | 🐛 1,762 | 🌐 C++ | 📅 2026-09-18, [Chocolatey](https://github.com/microsoft/terminal#via-chocolatey-unofficial) ⭐ 104,939 | 🐛 1,762 | 🌐 C++ | 📅 2026-09-18, or [Scoop](https://github.com/microsoft/terminal#via-scoop-unofficial) ⭐ 104,939 | 🐛 1,762 | 🌐 C++ | 📅 2026-09-18
...
**Installation:** Download the latest release from the [official repository](https://github.com/microsoft/PowerToys/releases) ⭐ 138,839 | 🐛 7,737 | 🌐 C | 📅 2026-09-19
...
**Installation:** Visit the [official repository](https://github.com/files-community/Files) ⭐ 45,539 | 🐛 459 | 🌐 C# | 📅 2026-09-17 or simply insall it via the [Microsoft Store](https://www.microsoft.com/store/apps/9NGHP3DX8HDX)
...
**Installation:** Since [the project](https://github.com/josephbeattie/Fluent-Media-Player-Dev) ⭐ 1,220 | 🐛 54 | 🌐 C# | 📅 2025-10-23 is in it's early phase of development you will need to build it via Visual Studio
