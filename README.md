...
**Installation:** See [here](https://github.com/khanhas/spicetify-cli/wiki/Installation) ⭐ 24,527 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-16
...
**Installation:** [Releases](https://github.com/rocksdanister/lively/releases) ⭐ 19,626 | 🐛 389 | 🌐 C# | 📅 2026-04-30
...
**Installation:** Download it from the [Microsoft Store](https://www.microsoft.com/en-us/p/notepads-app/9nhl4nsc67wm) or from [GitHub](https://github.com/JasonStein/Notepads) ⭐ 10,256 | 🐛 464 | 🌐 C# | 📅 2026-04-20
...
**Installation:** Download it from [here](https://github.com/Eugeny/tabby/releases) ⭐ 74,517 | 🐛 2,833 | 🌐 TypeScript | 📅 2026-09-16
...
**Installation:** Visit the [GitHub Repo](https://github.com/yshui/picom) ⭐ 4,795 | 🐛 277 | 🌐 C | 📅 2026-06-02 and follow the instructions.
...
**Installation:** Download or compile the app from the [repo](https://github.com/namazso/SecureUxTheme) ⭐ 3,129 | 🐛 21 | 🌐 C++ | 📅 2025-06-30.
...
**Installation:** See the latest release [here](https://github.com/White-Tiger/T-Clock/releases/tag/v2.4.4%23492-rc) ⭐ 1,846 | 🐛 170 | 🌐 C | 📅 2021-01-07
...
**Instalation:** Install it via the [Microsoft Store](https://www.microsoft.com/ro-ro/p/translucenttb/9pf4kz2vn4w9?activetab=pivot:overviewtab), or via [GitHub](https://github.com/TranslucentTB/TranslucentTB) ⭐ 20,352 | 🐛 325 | 🌐 C++ | 📅 2026-09-10
...
**Installation**: Install it via the ([Microsoft Store](https://www.microsoft.com/store/productId/9N0DX20HK701), [GitHub](https://github.com/microsoft/terminal#via-github) ⭐ 104,909 | 🐛 1,756 | 🌐 C++ | 📅 2026-09-16, [WinGet](https://github.com/microsoft/terminal#via-windows-package-manager-cli-aka-winget) ⭐ 104,909 | 🐛 1,756 | 🌐 C++ | 📅 2026-09-16, [Chocolatey](https://github.com/microsoft/terminal#via-chocolatey-unofficial) ⭐ 104,909 | 🐛 1,756 | 🌐 C++ | 📅 2026-09-16, or [Scoop](https://github.com/microsoft/terminal#via-scoop-unofficial) ⭐ 104,909 | 🐛 1,756 | 🌐 C++ | 📅 2026-09-16
...
**Installation:** Download it via the [releases page of the repo](https://github.com/mydockfinder/mydockfinder-for-Win10-Win11/releases) ⭐ 1,296 | 🐛 620 | 📅 2026-05-12
...
**Installation:** Download the latest release from the [official repository](https://github.com/microsoft/PowerToys/releases) ⭐ 138,753 | 🐛 7,710 | 🌐 C | 📅 2026-09-16
...
**Installation:** Visit the [official repository](https://github.com/files-community/Files) ⭐ 45,475 | 🐛 457 | 🌐 C# | 📅 2026-09-16 or simply insall it via the [Microsoft Store](https://www.microsoft.com/store/apps/9NGHP3DX8HDX)
...
**Installation:** Since [the project](https://github.com/josephbeattie/Fluent-Media-Player-Dev) ⭐ 1,219 | 🐛 54 | 🌐 C# | 📅 2025-10-23 is in it's early phase of development you will need to build it via Visual Studio
...
**Installation**: Visit the [releases](https://github.com/tjackenpacken/taskbar-groups/releases/tag/v0.2.0.0) ⭐ 2,779 | 🐛 277 | 🌐 C# | 📅 2024-07-04
