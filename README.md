...
**Installation:** See [here](https://github.com/khanhas/spicetify-cli/wiki/Installation) ⭐ 24,077 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-13
...
**Installation:** [Releases](https://github.com/rocksdanister/lively/releases) ⭐ 19,403 | 🐛 387 | 🌐 C# | 📅 2026-04-30
...
**Installation:** Download it from the [Microsoft Store](https://www.microsoft.com/en-us/p/notepads-app/9nhl4nsc67wm) or from [GitHub](https://github.com/JasonStein/Notepads) ⭐ 10,213 | 🐛 463 | 🌐 C# | 📅 2026-04-20
...
**Installation:** Download it from [here](https://github.com/Eugeny/tabby/releases) ⭐ 73,933 | 🐛 2,850 | 🌐 TypeScript | 📅 2026-08-12
...
**Installation:** Visit the [GitHub Repo](https://github.com/yshui/picom) ⭐ 4,772 | 🐛 275 | 🌐 C | 📅 2026-06-02 and follow the instructions.
...
**Installation:** Download or compile the app from the [repo](https://github.com/namazso/SecureUxTheme) ⭐ 3,110 | 🐛 18 | 🌐 C++ | 📅 2025-06-30.
...
**Installation:** See the latest release [here](https://github.com/White-Tiger/T-Clock/releases/tag/v2.4.4%23492-rc) ⭐ 1,843 | 🐛 169 | 🌐 C | 📅 2021-01-07
...
**Instalation:** Install it via the [Microsoft Store](https://www.microsoft.com/ro-ro/p/translucenttb/9pf4kz2vn4w9?activetab=pivot:overviewtab), or via [GitHub](https://github.com/TranslucentTB/TranslucentTB) ⭐ 20,096 | 🐛 327 | 🌐 C++ | 📅 2026-08-14
...
**Installation**: Install it via the ([Microsoft Store](https://www.microsoft.com/store/productId/9N0DX20HK701), [GitHub](https://github.com/microsoft/terminal#via-github) ⭐ 104,620 | 🐛 1,738 | 🌐 C++ | 📅 2026-08-15, [WinGet](https://github.com/microsoft/terminal#via-windows-package-manager-cli-aka-winget) ⭐ 104,620 | 🐛 1,738 | 🌐 C++ | 📅 2026-08-15, [Chocolatey](https://github.com/microsoft/terminal#via-chocolatey-unofficial) ⭐ 104,620 | 🐛 1,738 | 🌐 C++ | 📅 2026-08-15, or [Scoop](https://github.com/microsoft/terminal#via-scoop-unofficial) ⭐ 104,620 | 🐛 1,738 | 🌐 C++ | 📅 2026-08-15
...
**Installation:** Download it via the [releases page of the repo](https://github.com/mydockfinder/mydockfinder-for-Win10-Win11/releases) ⭐ 1,295 | 🐛 611 | 📅 2026-05-12
...
**Installation:** Download the latest release from the [official repository](https://github.com/microsoft/PowerToys/releases) ⭐ 137,787 | 🐛 7,482 | 🌐 C | 📅 2026-08-15
...
**Installation:** Visit the [official repository](https://github.com/files-community/Files) ⭐ 44,632 | 🐛 462 | 🌐 C# | 📅 2026-08-14 or simply insall it via the [Microsoft Store](https://www.microsoft.com/store/apps/9NGHP3DX8HDX)
...
**Installation:** Since [the project](https://github.com/josephbeattie/Fluent-Media-Player-Dev) ⭐ 1,223 | 🐛 54 | 🌐 C# | 📅 2025-10-23 is in it's early phase of development you will need to build it via Visual Studio
...
**Installation:** Visit the [official repository](https://github.com/blahsd/snwe) ⭐ 307 | 🐛 16 | 🌐 JavaScript | 📅 2022-12-07
...
**Installation:** Download it from the [Microsoft Store](https://www.microsoft.com/en-us/p/clipboard-canvas/9nn2nzg8rltb#activetab=pivot:overviewtab) or [GitHub](https://github.com/d2dyno1/ClipboardCanvas/releases) ⭐ 141 | 🐛 7 | 🌐 C# | 📅 2025-01-15
...
**Installation:** Currently hyper is complicated to install. We don't recommend installing hyper. [Want to install anyway?](https://github.com/hyperts/Hyper) ⭐ 69 | 🐛 3 | 🌐 TypeScript | 📅 2021-12-19
...
**Installation**: Visit the [releases](https://github.com/tjackenpacken/taskbar-groups/releases/tag/v0.2.0.0) ⭐ 2,776 | 🐛 276 | 🌐 C# | 📅 2024-07-04
...
**Installation:** See the [installation wiki](https://github.com/dylanaraps/neofetch/wiki/Installation) ⚠️ Archived
